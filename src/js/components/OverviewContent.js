    ...
    return `
        ...
        <div class="movie-more-information-card">
            ...
            <div class="movie-more-information">
                ...
                <p class="movie-more-information__movie-release-information movie-more-information--expandable hidden">Release date: <span class="movie-more-information__release-year">${
                    movie.Released
